...
function fn_modify_member_info(member_id,mod_type){
	...
	// alert("mod_type:"+mod_type);
		...
		$.ajax({
			...
			url : "http://localhost:8090/bookstore/admin/member/modifyMemberInfo.do",
			data : {
				member_id:member_id,
				mod_type:mod_type,
				value:value
...
function fn_delete_member(member_id ,del_yn){
    ...
    frm_mod_member.action="/bookstore/admin/member/deleteMember.do";
			...
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
					  ...
					  <br>
					  <p> 
					   주소:<br><input type="text" id="address"  name="address" size="50" value="${member_info.address }"><br><br>
